...
def roll_dice(num_rolls, dice=six_sided):
    ...
    for _ in range(num_rolls):
        current_point = dice() #get the point on the dice
        if current_point == 1:
            pig_out_flag = True #pig out situation occurs
        else:
    ...
    def say(score0,score1):
        ...
        if who == 1:
            ...
            if gain <= previous_high:
                ...
                return say
            elif gain == 1 and gain > previous_high: #case of gaining 1 point
...
def max_scoring_num_rolls(dice=six_sided, num_samples=1000):
    ...
    for i in range(1,11):
        ...
        new_ave = averaged_roll_dice(i, dice)
        if new_ave > largest_ave:
            largest_ave = new_ave
            max_scoring_num = i
...
def swap_strategy(score, opponent_score, margin=8, num_rolls=4):
    ...
    """
    # BEGIN PROBLEM 11
    points_with_freebacon = score + free_bacon(opponent_score)
    if opponent_score % points_with_freebacon == 0:
        return 0
    elif points_with_freebacon % opponent_score == 0:
        return num_rolls
    else:
